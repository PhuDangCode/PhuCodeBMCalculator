...
def BMI():
    ...
    if bmi<=18.5:
        ...
        label3.config(text="A doctor may adivise!")
    else:
        label2.config(text="obs!")
        label3.config(text="Health are may risk!")
...
def slider_changed(event):
    ...
    secondimage.place(x=50,y=550-size)
...
Button(root,text="view Report",width=15,height=2,font="arial 10 bold",bg="black",fg="white",command=BMI).place(x=280,y=340)
